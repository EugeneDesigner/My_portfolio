...
const Lift=()=> (
  ...
  <svg width="100%"
     height="60px" viewBox="0 0 78.5 149.404" enableBackground="new 0 0 78.5 149.404">
  <g id="Lift">
 ...
 componentWillUnmount() {
  ...
  handleScroll(e) {
    let scrollTop = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0,
        element   = this.refs.lift.offsetTop;

    console.log(scrollTop, element);
    if (scrollTop > element && this.state.count == 0) {
      let tops = scrollTop - element;
      this.setState({
        position: 'fixed',
        count: 1,
        top: tops + 'px'
  ...
  render() {
   ...
   console.log(css);
    ...
    return (
      ...
      <section className={s.first_background}>
        <div className={s.lift} ref="lift" style={css}><Lift  /></div>
      ...
      <section className={cx(s.color_background, s.bulb)}>
        <article className={s.main}>
      ...
      <section id="wireframing" className={cx(s.color_background, s.wireframing)}>
        <article className={s.main}>
      ...
      <section className={cx(s.color_background, s.draw)}>
        <article className={s.main}>
      ...
      <section  className={cx(s.color_background, s.comp)}>
        <article className={s.main}>
      ...
      <section className={cx(s.color_background, s.sunset)}>
        <article className={s.main}>
       </article>
      </section>
